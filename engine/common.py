...
def set_seed(seed: int) -> None:
    ...
    The DataLoader workers also inherit the seed via PYTHONHASHSEED. cuDNN is
    set to deterministic mode — slower, but the demo / smoke runs are CPU /
    small-batch where determinism matters more than the throughput.
    """
    seed = int(seed)
